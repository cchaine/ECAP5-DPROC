\section{Write-Back Module}
  ...
  \subsection{Interface}
    ...
    \input{arch/tables/11_wbm-interface}
  ...
  \subsection{Specification}
    ...
    \subsubsection{Upstream requirements}
      ...
      \input{arch/tables/11_wbm-upstream-requirements}
  ...
  \subsection{Behavior}
    ...
    \subsubsection{Instruction with output behavior}
      ...
      \begin{figure}[H]
          \centering
          \input{arch/figures/11_wbm-behavior-instruction-with-output.tex}
    ...
    \subsubsection{Instruction without output behavior}
      ...
      \begin{figure}[H]
          \centering
          \input{arch/figures/11_wbm-behavior-instruction-without-output.tex}
