  ...
  \subsection{Specification}
    ...
    \subsubsection{Input registering}
      ...
      \req{D\_EXM\_INPUT\_BUBBLE\_01}{
          The registered input values shall be overwritten with the values provided in table \ref{tab:exm-bubble-input} when \eventref{EV\_EXM\_INPUT\_REGISTER\_01} is triggered and \texttt{input\_valid\_o} is deasserted.
        }

      \req{D\_EXM\_INPUT\_BUBBLE\_02}{
          The registered input values shall be overwritten with the values provided in table \ref{tab:exm-bubble-input} on the rising edge of \texttt{clk\_i} when \texttt{rst\_i} is asserted.
        }
