  ...
  \subsection{Specification}
    ...
    \subsubsection{Input handshake}
      ...
      \req{D\_EXM\_INPUT\_REGISTER\_02}{
          Input registers shall be loaded with values from table \ref{tab:exm-bubble-input} on the rising edge of \texttt{clk\_i} when \texttt{rst\_i} is asserted.
        }

      \req{D\_EXM\_INPUT\_REGISTER\_03}{
          Input registers shall be loaded with values from table \ref{tab:exm-bubble-input} on the rising edge of \texttt{clk\_i} when \texttt{input\_ready\_o} is asserted and \texttt{input\_valid\_i} is deasserted.
        }
    ...
    \subsubsection{Output handshake}
      ...
      \req{D\_EXM\_OUTPUT\_HANDSHAKE\_01}{
          The \texttt{output\_valid\_o} output shall be asserted on the rising edge of \texttt{clk\_i} after \texttt{input\_ready\_o} is asserted.
        }
