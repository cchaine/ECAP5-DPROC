\section{Architecture overview}
  ...
  \subsection{Architecture specification}
    ...
    \subsubsection{Internal buses}

      \req{A\_INTERNAL\_BUS\_01}{
          The bus interface between the IFM and EMM shall be compliant with the pipelined wishbone B4 specification.
        }

      \req{A\_INTERNAL\_BUS\_02}{
          The bus interface between the EXM and EMM shall be compliant with the pipelined wishbone B4 specification.
        }

    \subsubsection{Module-specific requirements}
