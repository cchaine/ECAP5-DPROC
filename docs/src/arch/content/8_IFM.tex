  ...
  \subsection{Specification}
    ...
    \subsubsection{Functional requirements}
      ...
      \begin{figure}[H]
          ...
          \label{fig:ifm-wishbone-single-write-cycle}
        \end{figure}

      \input{arch/tables/8_ifm-wishbone-single-write-cycle}

      \req{D\_IFM\_WISHBONE\_WRITE\_CYCLE\_01}{
          A write transaction shall be started by asserting \texttt{wb\_cyc\_o}, \texttt{wb\_stb\_i} and \texttt{wb\_we\_o}.
        }

      \req{D\_IFM\_WISHBONE\_WRITE\_CYCLE\_02}{
