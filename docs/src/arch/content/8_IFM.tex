\section{Instruction Fetch Module}
  ...
  \subsection{Specification}
    ...
    \subsubsection{Upstream requirements}
      ...
      \input{arch/tables/8_ifm-upstream-requirements}
    ...
    \subsubsection{Functional requirements}
      ...
      \req{D\_IFM\_PC\_INCREMENT\_02}{
          The value of the \texttt{pc} register shall be incremented by the value of \texttt{boffset\_i} on the rising edge of \texttt{clk\_i} when \texttt{branch\_i} is asserted.
        }[
      ...
      \req{D\_IFM\_OUTPUT\_01}{
          The signal \texttt{instr\_o} shall be set to the value represented by \texttt{wb\_dat\_i} on the rising edge of \texttt{clk\_i} when \texttt{wb\_ack\_i} is asserted.
        }

      \req{D\_IFM\_OUTPUT\_02}{
          The signal \texttt{pc\_o} shall be set to the value of the \texttt{pc} register.
        }
      ...
      \req{D\_IFM\_OUTPUT\_HANDSHAKE\_02}{
          The signal \texttt{output\_valid\_o} shall be asserted on the rising edge of \texttt{clk\_i} when \texttt{wb\_ack\_i} is asserted.
        }[
          rationale=Refer to section \ref{control-hazard}.
        ]
