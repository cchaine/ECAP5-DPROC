...
\begin{figure}[h!]
    \centering
    \input{arch/figures/regm-arch.tex}
...
\input{arch/tables/regm-interface}
...
\input{arch/tables/regm-upstream-requirements}
...
\req{D\_REGM\_READ\_PORT\_01}{
  The register module shall provide two asynchronous reading ports for accessing registers from \texttt{x0} to \texttt{x31}.
}[
  derivedfrom=F\_REGISTERS\_01
]

\req{D\_REGM\_WRITE\_PORT\_01}{
  The register module shall provide one synchronous writing port for modifying registers from \texttt{x0} to \texttt{x31}.
}[
  derivedfrom=F\_REGISTERS\_01
]
...
\begin{figure}[H]
    \centering
    \input{arch/figures/regm-behavior-read.tex}
...
\begin{figure}[H]
    \centering
    \input{arch/figures/regm-behavior-write.tex}
...
\begin{figure}[H]
    \centering
    \input{arch/figures/regm-behavior-read-before-write.tex}
