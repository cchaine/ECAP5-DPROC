...
\begin{content}
  ...
  \begin{itemize}
    ...
    \vspace{-0.5em}
    \item The decode stage handles the instruction decoding to provide the next stage with the different instruction input values. This includes reading from internal registers.
    \vspace{-0.5em}
