...
\begin{tikzpicture}[scale=1.25, draw=gray, inner sep=0, outer sep=0]
  ...
  \node[rectangle, draw=black,
    minimum height = 2cm,
    minimum width = 2cm,
    fill = blue!30!gray!20] (WBM) at (12, 0) {WBM};
  ...
  \node (hzdm-port1) at ([xshift=-0.3cm]HZDM.south) {};
  \node (hzdm-port2) at ([xshift=-0.1cm]HZDM.south) {};
  \node (hzdm-port3) at ([xshift=0.1cm]HZDM.south) {};
  \node (hzdm-port4) at ([xshift=0.3cm]HZDM.south) {};
  ...
  \node (wbm-hzd-port-mid) at ([yshift=0.7cm]wbm-hzd-port.center) {};
  ...
  \draw[-, red] (wbm-hzd-port) -- (wbm-hzd-port-mid) -- (hzdm-port4 |- wbm-hzd-port-mid) -- (hzdm-port4);
