...
#include "testbench.h"
#include "Vtb_execute_ecap5_dproc_pkg.h"
...
public:
  ...
  void _nop() {
    ...
    this->core->alu_op_i = Vtb_execute_ecap5_dproc_pkg::ALU_ADD;
    ...
    this->core->branch_cond_i = Vtb_execute_ecap5_dproc_pkg::NO_BRANCH;
  ...
  void _xor(uint32_t operand1, uint32_t operand2, uint32_t reg_addr) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->alu_op_i = Vtb_execute_ecap5_dproc_pkg::ALU_XOR;
    this->core->branch_cond_i = 0;
    this->core->reg_write_i = 1;
    this->core->reg_addr_i = reg_addr;
  }
  ...
  void _or(uint32_t operand1, uint32_t operand2, uint32_t reg_addr) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->alu_op_i = Vtb_execute_ecap5_dproc_pkg::ALU_OR;
    this->core->branch_cond_i = 0;
    this->core->reg_write_i = 1;
    this->core->reg_addr_i = reg_addr;
  }
  ...
  void _and(uint32_t operand1, uint32_t operand2, uint32_t reg_addr) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->alu_op_i = Vtb_execute_ecap5_dproc_pkg::ALU_AND;
    this->core->branch_cond_i = 0;
    this->core->reg_write_i = 1;
    this->core->reg_addr_i = reg_addr;
  }
  ...
  void _slt(uint32_t operand1, uint32_t operand2, uint32_t reg_addr) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->alu_op_i = Vtb_execute_ecap5_dproc_pkg::ALU_SLT;
    this->core->branch_cond_i = 0;
    this->core->reg_write_i = 1;
    this->core->reg_addr_i = reg_addr;
  }
  ...
  void _sltu(uint32_t operand1, uint32_t operand2, uint32_t reg_addr) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->alu_op_i = Vtb_execute_ecap5_dproc_pkg::ALU_SLTU;
    this->core->branch_cond_i = 0;
    this->core->reg_write_i = 1;
    this->core->reg_addr_i = reg_addr;
  }
  ...
  void _sll(uint32_t operand1, uint32_t operand2, uint32_t reg_addr) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->alu_op_i = Vtb_execute_ecap5_dproc_pkg::ALU_SHIFT;
  ...
  void _beq(uint32_t pc, uint32_t operand1, uint32_t operand2, uint32_t branch_offset) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->branch_cond_i = Vtb_execute_ecap5_dproc_pkg::BRANCH_BEQ;
  ...
  void _bne(uint32_t pc, uint32_t operand1, uint32_t operand2, uint32_t branch_offset) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->branch_cond_i = Vtb_execute_ecap5_dproc_pkg::BRANCH_BNE;
    this->core->branch_offset_i = branch_offset;
  }
  ...
  void _blt(uint32_t pc, uint32_t operand1, uint32_t operand2, uint32_t branch_offset) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->branch_cond_i = Vtb_execute_ecap5_dproc_pkg::BRANCH_BLT;
    this->core->branch_offset_i = branch_offset;
  }
  ...
  void _bltu(uint32_t pc, uint32_t operand1, uint32_t operand2, uint32_t branch_offset) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->branch_cond_i = Vtb_execute_ecap5_dproc_pkg::BRANCH_BLTU;
    this->core->branch_offset_i = branch_offset;
  }
  ...
  void _bge(uint32_t pc, uint32_t operand1, uint32_t operand2, uint32_t branch_offset) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->branch_cond_i = Vtb_execute_ecap5_dproc_pkg::BRANCH_BGE;
    this->core->branch_offset_i = branch_offset;
  }
  ...
  void _bgeu(uint32_t pc, uint32_t operand1, uint32_t operand2, uint32_t branch_offset) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->branch_cond_i = Vtb_execute_ecap5_dproc_pkg::BRANCH_BGEU;
    this->core->branch_offset_i = branch_offset;
  }
  ...
  void _jalr(uint32_t pc, uint32_t operand1, uint32_t operand2, uint32_t reg_addr) {
    ...
    this->core->alu_operand1_i = operand1;
    this->core->alu_operand2_i = operand2;
    this->core->branch_cond_i = Vtb_execute_ecap5_dproc_pkg::BRANCH_UNCOND;
    this->core->reg_write_i = 1;
    this->core->reg_addr_i = reg_addr;
  }
};

void tb_execute_alu_add(TB_Execute * tb) {
...
void tb_execute_alu_sub(TB_Execute * tb) {
  ...
  CHECK("tb_execute.alu.SUB_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.alu.SUB_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.alu.SUB_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_alu_xor(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.alu.XOR_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.alu.XOR_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.alu.XOR_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_alu_or(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.alu.OR_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.alu.OR_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.alu.OR_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_alu_and(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.alu.AND_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.alu.AND_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.alu.AND_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_alu_slt(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.alu.SLT_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.alu.SLT_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.alu.SLT_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_alu_sltu(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.alu.SLTU_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.alu.SLTU_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.alu.SLTU_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_alu_sll(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.alu.SLL_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.alu.SLL_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.alu.SLL_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_alu_srl(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.alu.SRL_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.alu.SRL_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.alu.SRL_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_alu_sra(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.alu.SRA_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.alu.SRA_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.alu.SRA_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_branch_beq(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.branch.BEQ_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.branch.BEQ_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.branch.BEQ_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_branch_bne(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.branch.BNE_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.branch.BNE_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.branch.BNE_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_branch_blt(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.branch.BLT_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.branch.BLT_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.branch.BLT_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_branch_bltu(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.branch.BLTU_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.branch.BLTU_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.branch.BLTU_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_branch_bge(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.branch.BGE_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.branch.BGE_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.branch.BGE_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_branch_bgeu(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.branch.BGEU_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.branch.BGEU_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.branch.BGEU_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_back_to_back(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.back_to_back.01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.back_to_back.02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.back_to_back.03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_bubble(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.bubble.01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.bubble.02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.bubble.03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}
...
void tb_execute_reset(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  core->alu_op_i = Vtb_execute_ecap5_dproc_pkg::ALU_ADD;
  core->alu_shift_left_i = rand() % 2;
  core->alu_signed_shift_i = rand() % 2;
  core->reg_write_i = 1;
  core->reg_addr_i = rand() % 32;
  core->branch_cond_i = Vtb_execute_ecap5_dproc_pkg::BRANCH_BEQ;
  core->branch_offset_i = rand() % 0xFFFFF;
  ...
  CHECK("tb_execute.reset.01",
      tb->conditions[COND_input_ready],
      "Failed to implement the input_ready_o", tb->err_cycles[COND_input_ready]);

  CHECK("tb_execute.reset.02",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.reset.03",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.reset.04",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}

void tb_execute_branch_jalr(TB_Execute * tb) {
  Vtb_execute * core = tb->core;
  ...
  CHECK("tb_execute.branch.JALR_01",
      tb->conditions[COND_result],
      "Failed to implement the result protocol", tb->err_cycles[COND_result]);

  CHECK("tb_execute.branch.JALR_02",
      tb->conditions[COND_branch],
      "Failed to implement the branch protocol", tb->err_cycles[COND_branch]);

  CHECK("tb_execute.branch.JALR_03",
      tb->conditions[COND_output_valid],
      "Failed to implement the output_valid_o", tb->err_cycles[COND_output_valid]);
}
...
int main(int argc, char ** argv, char ** env) {
  ...
  TB_Execute * tb = new TB_Execute;
  tb->open_trace("waves/execute.vcd");
  tb->open_testdata("testdata/execute.csv");
  ...
  tb_execute_alu_or(tb);
  tb_execute_alu_and(tb);
  tb_execute_alu_slt(tb);
  tb_execute_alu_sltu(tb);
  tb_execute_alu_sll(tb);
  tb_execute_alu_srl(tb);
  tb_execute_alu_sra(tb);

  tb_execute_branch_beq(tb);
  tb_execute_branch_bne(tb);
  tb_execute_branch_blt(tb);
  tb_execute_branch_bltu(tb);
  tb_execute_branch_bge(tb);
  tb_execute_branch_bgeu(tb);

  tb_execute_branch_jalr(tb);
